    ...
    <div ref={containerRef} className="w-full max-w-2xl mx-auto" style={{ opacity: 0 }}>
      <form onSubmit={handleSubmit} className="relative">
        <input
          ...
          className="w-full bg-foreground/5 border border-foreground/15 backdrop-blur-md pl-5 pr-14 py-4 sm:py-5 text-sm sm:text-base text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/60 transition-all duration-300"
        />
        <button
          type="submit"
          disabled={!value.trim()}
